    ...
    return (
      <Grid className={classes.featuredStory} item md={9} xs={12}>
        <Grid alignItems='flex-end' container style={{ height: '100%' }}>
          <Grid item style={{ backgroundColor: 'rgba(0,0,0,.35)', color: 'white', padding: 5, width: '60%' }}>
    ...
    return stories.map((story) => {
      ...
      return (
        <Grid className={classes.story} item key={story.name} xs={12}>
          <Grid alignItems='flex-end' container style={{ height: '100%' }}>
            <Grid item style={{ backgroundColor: 'rgba(0,0,0,.35)', color: 'white', padding: 5, width: '100%' }}>
