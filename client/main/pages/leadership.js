  ...
  const Header = () => (
    <Grid item xs={12}>
      ...
      <Typography className={classes.quote}>
        I always like to think that companies are not actually 
        structured in the way that many people portray them 
        &mdash; a pyramid with the executives at the top. 
        Conversely, I believe that companies are really 
        structured as an inverted pyramid where company leaders 
        serve its employees. <b>&mdash; <i>Ross Sheppard</i></b>
      </Typography>
    </Grid>
  );
